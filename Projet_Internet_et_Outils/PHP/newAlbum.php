...
<form action="" method="post" onsubmit="alert('Votre demande à bien été prise en compte, merci !')">
    ...
    <label for="checkbox">Présente-il plusieurs artistes principaux</label>
    ...
    checkbox.addEventListener('change', function() {
        // affiche les champs de texte si la case à cocher est cochée 
        if (checkbox.checked) {
...
if($connexion){
    if (isset($nom)&&isset($artiste)&&isset($annee)&&!isset($feat1)&&!isset($feat2)&&!isset($feat3)&&!isset($feat4)){
        mysqli_query($connexion, "INSERT INTO new_album (nom,artiste,annee) VALUES ('$nom','$artiste','$annee');");
    }else if(isset($nom)&&isset($artiste)&&isset($annee)&&isset($feat1)&&!isset($feat2)&&!isset($feat3)&&!isset($feat4)){
        mysqli_query($connexion, "INSERT INTO new_album (nom,artiste,annee,feat1) VALUES ('$nom','$artiste','$annee','$feat1');");
    }else if(isset($nom)&&isset($artiste)&&isset($annee)&&isset($feat1)&&isset($feat2)&&!isset($feat3)&&!isset($feat4)){
        mysqli_query($connexion, "INSERT INTO new_album (nom,artiste,annee,feat1,feat2) VALUES ('$nom','$artiste','$annee','$feat1','$feat2');");
    }else if(isset($nom)&&isset($artiste)&&isset($annee)&&isset($feat1)&&isset($feat2)&&isset($feat3)&&!isset($feat4)){
        mysqli_query($connexion, "INSERT INTO new_album (nom,artiste,annee,feat1,feat2,feat3) VALUES ('$nom','$artiste','$annee','$feat1','$feat2','$feat3');");
    }else if(isset($nom)&&isset($artiste)&&isset($annee)&&isset($feat1)&&isset($feat2)&&isset($feat3)&&isset($feat4)){
        mysqli_query($connexion, "INSERT INTO new_album (nom,artiste,annee,feat1,feat2,feat3,feat4) VALUES ('$nom','$artiste','$annee','$feat1','$feat2','$feat3','$feat4');");
    }
}
